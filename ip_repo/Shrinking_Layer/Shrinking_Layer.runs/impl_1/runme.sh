...
HD_PWD='D:/FSRCNN/ip_repo/Shrinking_Layer/Shrinking_Layer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Shrinking_Layer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Shrinking_Layer.tcl -notrace
