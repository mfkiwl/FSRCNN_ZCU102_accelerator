...
HD_PWD='D:/FSRCNN/ip_repo/Shrinking_Layer/Shrinking_Layer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Shrinking_Layer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Shrinking_Layer.tcl
