...
#
# Script generated by Vivado on Tue Jul 29 00:19:31 +0900 2025
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/FSRCNN/ip_repo/Shrinking_Layer/Shrinking_Layer.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
