...
#
# Script generated by Vivado on Sun Aug 10 15:12:20 +0900 2025
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/FSRCNN/ip_repo/Expanding_Layer/Expanding_Layer.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
