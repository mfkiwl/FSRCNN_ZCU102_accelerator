...
HD_PWD='D:/FSRCNN/ip_repo/Expanding_Layer/Expanding_Layer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Expanding_Layer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Expanding_Layer.tcl -notrace
