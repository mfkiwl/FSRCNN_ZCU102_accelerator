...
HD_PWD='D:/FSRCNN/ip_repo/Expanding_Layer/Expanding_Layer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Expanding_Layer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Expanding_Layer.tcl
